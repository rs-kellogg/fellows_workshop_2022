...
setwd("~/fellows_workshop_2022/Session2_Automation/interest_rates/data/raw")
...
# Save Results
#setwd("~/fellows_workshop_2022/Session2_Automation/interest_rates/data")
...
print("Successfully cleaned interest rate data.")
